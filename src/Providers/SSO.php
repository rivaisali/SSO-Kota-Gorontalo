...
class SSO extends AbstractProvider
{
    ...
    /**
     * SSO URL, eg. http://localhost:8080/auth.
     *
     * @var string
     */
    ...
    /**
     * Updates expected encryption algorithm of SSO instance.
     *
    ...
    /**
     * Updates expected encryption key of SSO instance.
     *
    ...
    /**
     * Updates expected encryption key of SSO instance to content of given
     * file path.
     *
    ...
    {
        // We have a problem with SSO when the userinfo responses
        // with a jwt token
